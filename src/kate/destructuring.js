//Destruct means - Create new variables by get value from a Object or Array.
//first lets create a object to use as a example.
...
//Now that we have a object, I wanna create 2 variables just with firstName and lastName.
//This is the sintax
...
//Now, I want to create a variable with city and country. How can I destruct that? My Address is a object inside of Person object.
//the sintax is the same, just pass the Address object.
...
//Remember, when we destruct a object, we are creating new variables from the values.

const personInfo = ( { firstName, lastName, age } ) => {
    console.log(`Hello, my name is ${firstName} ${lastName}, and I am ${age} years old.`);
}

//In my function personInfo, we are destructuring a Object right? and this object should have as properties firstName, lastName and Age.
...
//now we have 2 people, Tim and Kate. However, Tim has middleName and Kate doesnt have.
...
//because Kate doestn have fullname, the middleName variable is set as undefined.
//Tim object wont have this problem because it has the middleName.
